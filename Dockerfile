FROM --platform=$BUILDPLATFORM node:20@sha256:c10929a76495ac7e6685bcef0a858ac7ccb30b2b54fdb654617a5eef67086854 as deps
RUN mkdir /app
WORKDIR /app
...
FROM --platform=$TARGETPLATFORM node:20@sha256:c10929a76495ac7e6685bcef0a858ac7ccb30b2b54fdb654617a5eef67086854 as platform_deps
RUN mkdir /app
WORKDIR /app
RUN apt-get update && apt-get install -y git python3 build-essential libc-dev
...
FROM node:20@sha256:c10929a76495ac7e6685bcef0a858ac7ccb30b2b54fdb654617a5eef67086854 as base
RUN mkdir /app
WORKDIR /app
