FROM --platform=$BUILDPLATFORM node:22@sha256:37ff334612f77d8f999c10af8797727b731629c26f2e83caa6af390998bdc49c as deps
RUN mkdir /app
WORKDIR /app
...
FROM --platform=$TARGETPLATFORM node:22@sha256:37ff334612f77d8f999c10af8797727b731629c26f2e83caa6af390998bdc49c as platform_deps
RUN mkdir /app
WORKDIR /app
RUN apt-get update && apt-get install -y git python3 build-essential libc-dev
...
FROM node:22@sha256:37ff334612f77d8f999c10af8797727b731629c26f2e83caa6af390998bdc49c as base
RUN mkdir /app
WORKDIR /app
